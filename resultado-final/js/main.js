...
function cargarProductosPorCategoria(categoriaId) {
    const productosFiltrados = categoriaId === "todos" ? productos : productos.filter(producto => producto.categoria.id === categoriaId);
    tituloPrincipal.innerText = categoriaId === "todos" ? "Todos los productos" : categoriaId.charAt(0).toUpperCase() + categoriaId.slice(1);
...
function actualizarBotonesAgregar() {
    ...
    botonesAgregar.forEach(boton => {
        ...
        boton.addEventListener("mouseenter", () => {
            boton.classList.add("hover"); // Añadir efecto hover
        });
        boton.addEventListener("mouseleave", () => {
            boton.classList.remove("hover"); // Remover efecto hover
        });
    });
}
